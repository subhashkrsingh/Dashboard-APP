...
export function SidebarPanel({ companies, marketStatus, fetchedAt }: SidebarPanelProps) {
  return (
    <aside className="border-r border-slate-800/85 bg-slate-950/95 p-4 lg:p-5">
